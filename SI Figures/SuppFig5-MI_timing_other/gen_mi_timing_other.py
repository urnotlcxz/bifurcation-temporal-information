...
for mu in mus:
    ...
    for sigma in sigmas:
        c = NaP_K_model(dt=dt, N=num_ticks, odor_tau=odor_tau, odor_mu=mu, 
                        ...
                        k_rate=1./tau_rate)
        c.gen_sig_trace_OU_binary(seed=seed, smooth_T=smooth_T)
...
for mu in mus:
    ...
    for sigma in sigmas:
        c = NaP_K_model(dt=dt, N=num_ticks, odor_tau=odor_tau, odor_mu=mu, 
                        odor_sigma=sigma, rate_sigma=rate_sigma, 
                        k_rate=1./tau_rate)
        c.gen_sig_trace_OU_binary(seed=seed, smooth_T=smooth_T, partial='up')
...
for mu in mus:
    ...
    for sigma in sigmas:
        c = NaP_K_model(dt=dt, N=num_ticks, odor_tau=odor_tau, odor_mu=mu, 
                        odor_sigma=sigma, rate_sigma=rate_sigma, 
                        k_rate=1./tau_rate)
        c.gen_sig_trace_Gaussian(seed=seed)
