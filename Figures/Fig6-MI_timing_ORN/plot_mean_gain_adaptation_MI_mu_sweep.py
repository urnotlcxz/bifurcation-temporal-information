...
This script plots MI- plot over mu using Na+K+Ca model
...
file = './data/NaKCa_MI_mu_sweep_m1_s1_Km0.1.pkl'
...
plt.xlim(0.01, 1)
if SAVEFIG:
    save_fig('NaKCa_MI_mean_adaptation')
plt.show()
...
plt.xlim(0.001, 0.1)
if SAVEFIG:
    save_fig('NaKCa_MI_mean_adaptation_mu_scaled')
plt.show()
